...
final_scores = andrew_rf_scores + andrew_knn_scores + andrew_adaboost_scores + zac_rf_scores + zac_knn_scores + zac_adaboost_scores + manisha_rf_scores + manisha_knn_scores + manisha_adaboost_scores + zac_scores + zac_scores

final_scores /= 11.0

np.savetxt('all_scores.txt', np.array(final_scores), newline='\n')
